...
public class BlueHardenedLeatherArmor extends ArmorItem {

    protected final Type slot;
    public static final Component EFFECT = Component.translatable("tooltip.has_blue_effect.tooltip").withStyle(ChatFormatting.GREEN);
    public static final Component NO_EFFECT = Component.translatable("tooltip.has_blue_effect.tooltip").withStyle(ChatFormatting.GRAY);
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(CustomArmorMaterials.BLUE_HARDENED_LEATHER,
                            new MobEffectInstance(MobEffects.WATER_BREATHING, 200, 1)).build();

    public BlueHardenedLeatherArmor(ArmorMaterial material, Type slot, Properties settings) {
        ...
        if (player != null) {
            ...
            if (isEquip) {
                if (hasFullSuitOfArmorOn(player)) {
                    if (hasCorrectArmorOn(CustomArmorMaterials.BLUE_HARDENED_LEATHER, player)) {
