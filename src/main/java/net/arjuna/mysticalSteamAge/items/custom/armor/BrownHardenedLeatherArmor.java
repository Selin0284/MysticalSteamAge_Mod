...
public class BrownHardenedLeatherArmor extends ArmorItem {

    protected final Type slot;
    public static final Component EFFECT = Component.translatable("tooltip.has_brown_effect.tooltip").withStyle(ChatFormatting.GREEN);
    public static final Component NO_EFFECT = Component.translatable("tooltip.has_brown_effect.tooltip").withStyle(ChatFormatting.GRAY);

    public BrownHardenedLeatherArmor(ArmorMaterial material, Type slot, Properties settings) {
        ...
        if (player != null) {
            ...
            if (isEquip) {
                if (hasFullSuitOfArmorOn(player)) {
                    if (hasCorrectArmorOn(CustomArmorMaterials.BROWN_HARDENED_LEATHER, player)) {
