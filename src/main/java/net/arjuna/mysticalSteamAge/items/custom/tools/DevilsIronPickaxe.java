...
public class DevilsIronPickaxe extends PickaxeItem {
    ...
    public DevilsIronPickaxe(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public boolean hurtEnemy(ItemStack stack, @NotNull LivingEntity pTarget, @NotNull LivingEntity pAttacker) {
        if(stack.getItem() == MysticalSteamAgeItemsRegister.devil_iron_pickaxe.get()) {
